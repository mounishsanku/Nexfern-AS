        ...
        <div className="grid gap-6 lg:grid-cols-12 lg:items-start">
          <section className="lg:col-span-7">
            ...
            <p className="mt-4 max-w-2xl text-pretty text-lg leading-7 text-slate-600">
              ...
              expenses, and reports—built with React, TypeScript, Tailwind, and
              an Express + MongoDB API.
            </p>

            <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:items-center">
              <Button to="/dashboard" variant="primary" className="shadow-soft-lg">
                Go to Dashboard
              </Button>
            ...
            <div className="mt-8 grid gap-3 sm:grid-cols-2">
              {[
                ...
                },
                {
                  title: "MERN-ready",
                  description:
                    "Frontend + backend run separately with a test API route.",
                },
              ].map((f) => (
                <div
                  key={f.title}
